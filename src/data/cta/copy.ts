...
export const CTA_LABELS = {
  ...
  strategySession: "Book an AI strategy session",
  ...
  seeProductionCases: "See production case studies",
  ...
  exploreAgentBank: "Explore Agent Bank",
  reviewSecurity: "Review security",
  askIra: "Ask IRA",
  footerStrategy: "Book a 30-minute strategy call",
