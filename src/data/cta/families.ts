 ...
 * intensity, tint, border, and hierarchy — all cyan / cyan-deep.
 * Explore never uses `fill`. Assessment uses a muted cyan-deep fill.
 */
...
export const ctaFamilyMeta = {
  fill: {
    ...
    color:
      "Strategy: bg-cyan; Assessment: bg-cyan-deep; hover bg-white text-ink",
  ...
  ghost: {
    ...
    color:
      "muted cyan-deep fill, white type; hover bg-white text-ink",
    background: "None",
  },
  text: {
    id: "text",
...
export const ctaFamilyClasses = {
  fill: {
    magnetic:
      "min-h-12 justify-center bg-cyan px-6 py-3 text-sm text-white hover:bg-white hover:text-ink",
    magneticHero:
      "min-h-12 shrink-0 justify-center whitespace-nowrap bg-cyan px-7 py-3.5 text-white shadow-[0_0_32px_rgba(0,190,212,0.22)] hover:bg-white hover:text-ink sm:px-8",
    assessment:
      "min-h-12 justify-center bg-cyan-deep px-6 py-3 text-sm text-white shadow-[0_0_20px_rgba(8,145,168,0.2)] hover:bg-white hover:text-ink",
    assessmentHero:
      "min-h-12 shrink-0 justify-center whitespace-nowrap bg-cyan-deep px-7 py-3.5 text-white shadow-[0_0_24px_rgba(8,145,168,0.22)] hover:bg-white hover:text-ink sm:px-8",
    header:
      "group relative inline-flex min-h-11 shrink-0 items-center justify-center gap-2 overflow-hidden rounded-full border border-cyan bg-cyan pl-4 pr-3.5 text-[12px] font-semibold tracking-wide text-white shadow-[0_0_24px_rgba(0,190,212,0.22)] transition-[background-color,border-color,box-shadow,color] duration-300 hover:border-white hover:bg-white hover:text-ink hover:shadow-[0_0_28px_rgba(255,255,255,0.18)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan/50 focus-visible:ring-offset-2 focus-visible:ring-offset-ink sm:text-[13px]",
  },
  ...
  ghost:
    "inline-flex min-h-12 shrink-0 items-center justify-center rounded-full border border-cyan-deep/40 bg-cyan-deep px-6 text-sm font-medium text-white shadow-[0_0_16px_rgba(8,145,168,0.16)] transition-colors hover:bg-white hover:text-ink",
  ghostStrategy:
  ...
  ghostOnPaper:
    "inline-flex min-h-12 shrink-0 items-center justify-center rounded-full border border-cyan-deep/35 bg-cyan-deep px-6 text-sm font-medium text-white transition-colors hover:bg-ink hover:text-white",
