  ...
  return (
    <div
      className={cn(
        ...
        "right-4 bottom-4 sm:right-5 sm:bottom-5 md:right-6 md:bottom-6",
      )}
    >
      <div
        className={cn(
      ...
      >
        ...
        >
          <a
            ...
            onClick={handleClick}
            className={cn(
              "group relative inline-flex items-center gap-2 rounded-full border border-cyan/55 bg-ink py-1 pr-3 pl-1",
