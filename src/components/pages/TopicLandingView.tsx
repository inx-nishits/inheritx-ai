...
export function TopicLandingView({ topic, crumbs }: TopicLandingViewProps) {
  ...
  const industryBanner = showIndustryImage ? (
    <div className="relative aspect-[16/10] w-full overflow-hidden rounded-[1.25rem] border border-white/10 bg-ink-soft md:rounded-[1.5rem]">
      <Image
        src={topic.image!}
        alt=""
        fill
  ...
  return (
    <>
      <PageHero
        ...
        media={industryBanner}
        className={industryBanner ? "md:pt-28 md:pb-16" : undefined}
      />
